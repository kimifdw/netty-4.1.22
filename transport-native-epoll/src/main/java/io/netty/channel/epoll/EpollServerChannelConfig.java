...
public class EpollServerChannelConfig extends EpollChannelConfig implements ServerSocketChannelConfig {
    ...
    /**
     * Returns threshold value of number of pending for fast open connect.返回快速打开连接的挂起数量的阈值。
     *
     ...
     * 在服务器通道上启用tcpFastOpen。如果底层操作系统不支持TCP_FASTOPEN设置，则此设置无效。在套接字上执行侦听之前必须设置此设置，否则此设置无效。
     */
