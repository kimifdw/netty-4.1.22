 ...
 * EventLoop在后台使用epoll。只在Linux上工作!
 */
//
...
//
    ...
    /**
     * Return a cleared {@link IovArray} that can be used for writes in this {@link EventLoop}.返回一个可以用于在这个EventLoop中写入的已清除的IovArray。
     */
    IovArray cleanArray() {
        iovArray.clear();
        return iovArray;
    ...
    /**
     * Register the given epoll with this {@link EventLoop}.用这个EventLoop来注册给定的epoll。
     */
//
    ...
    /**
     * The flags of the given epoll was modified so update the registration 给定epoll的标志被修改，因此更新注册
     */
//
...
//
     ...
     * 设置事件循环中I/O所需时间的百分比。默认值是50，这意味着事件循环将尝试在I/O任务上花费与非I/O任务相同的时间。
     */
