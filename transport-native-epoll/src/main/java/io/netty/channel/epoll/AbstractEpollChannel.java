...
abstract class AbstractEpollChannel extends AbstractChannel implements UnixChannel {
     ...
     * connection attempts will fail.当前连接尝试的未来。如果不为空，后续连接尝试将失败。
     */
...
//
    ...
    /**
     * Returns an off-heap copy of the specified {@link ByteBuf}, and releases the original one.返回指定ByteBuf的堆外副本，并释放原始副本。
     */
...
//
        ...
        /**
         * Called once EPOLLRDHUP event is ready to be processed 一旦EPOLLRDHUP事件准备好被处理，调用
         */
//
        ...
        /**
         * Clear the {@link Native#EPOLLRDHUP} flag from EPOLL, and close on failure.清晰的本机。epollerdhup标志来自EPOLL，失败时关闭。
         */
//
...
//
        ...
        /**
         * Called once a EPOLLOUT event is ready to be processed 一旦EPOLLOUT事件准备好处理，就调用它
         */
