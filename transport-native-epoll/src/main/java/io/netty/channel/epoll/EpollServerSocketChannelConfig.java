...
public final class EpollServerSocketChannelConfig extends EpollServerChannelConfig
     ...
     * any affect.
     * 在底层通道上设置SO_REUSEPORT选项。这将允许将多个epollsocketchannel绑定到同一个端口，从而接受具有多个线程的连接。请注意，在EpollSocketChannel.bind .bind(java.net.SocketAddress)产生任何影响之前需要调用此方法。
     */
     ...
     * 在套接字上设置TCP_DEFER_ACCEPT选项。有关更多细节，请参阅man 7 tcp。
     */
    ...
    /**
     * Returns a positive value if <a href="http://linux.die.net/man/7/tcp">TCP_DEFER_ACCEPT</a> is enabled.如果启用TCP_DEFER_ACCEPT，则返回一个正值。
     */
