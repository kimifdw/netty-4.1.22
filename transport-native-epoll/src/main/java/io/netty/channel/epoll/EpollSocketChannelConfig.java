...
//
     ...
     * @return value is a uint32_t 获取套接字上的TCP_NOTSENT_LOWAT选项。有关更多细节，请参阅man 7 tcp。
     */
     ...
     * 在套接字上设置TCP_MD5SIG选项。看到linux / tcp。h了解更多细节。由于密匙是机密的，所以只能设置密匙，而不能读取，以防止潜在的泄漏。允许他们被阅读将意味着任何有渠道的人可以得到他们。
     */
     ...
     * for more details.在套接字上设置TCP_QUICKACK选项。有关详细信息，请参阅TCP_QUICKACK。
     */
     ...
     * {@code false} otherwise.如果启用TCP_QUICKACK，返回true，否则返回false。
     */
     ...
     * for more details.在套接字上设置TCP_FASTOPEN_CONNECT选项。需要Linux内核4.11或更高版本。有关更多细节，请参见此提交。
     */
    ...
    /**
     * Returns {@code true} if {@code TCP_FASTOPEN_CONNECT} is enabled, {@code false} otherwise.如果启用TCP_FASTOPEN_CONNECT，返回true，否则返回false。
     */
