...
/**
 * An {@link SslContext} which uses JDK's SSL/TLS implementation.使用JDK的SSL/TLS实现的SslContext。
 */
public class JdkSslContext extends SslContext {
    ...
    /**
     * Creates a new {@link JdkSslContext} from a pre-configured {@link SSLContext}.从预先配置的SSLContext中创建一个新的JdkSslContext。
     *
    ...
    /**
     * Returns the JDK {@link SSLContext} object held by this context.返回此上下文持有的JDK SSLContext对象。
     */
    ...
    /**
     * Translate a {@link ApplicationProtocolConfig} object to a {@link JdkApplicationProtocolNegotiator} object.将ApplicationProtocolConfig对象转换为jdkapplicationprotocol协商器对象。
     ...
     * and a certificate chain.
     * @deprecated will be removed.
     * 基于密钥算法、密钥文件、密钥文件密码和证书链构建KeyManagerFactory。
     */
    @Deprecated
