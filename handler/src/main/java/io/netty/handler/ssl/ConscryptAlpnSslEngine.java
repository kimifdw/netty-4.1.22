...
/**
 * A {@link JdkSslEngine} that uses the Conscrypt provider or SSL with ALPN.一个使用Conscrypt提供程序或SSL的JdkSslEngine。
 */
abstract class ConscryptAlpnSslEngine extends JdkSslEngine {
     ...
     * 计算包装给定的明文字节所需的加密输出缓冲区的最大大小。假设每个缓冲区有一个TLS记录，这是最坏的情况。
     */
