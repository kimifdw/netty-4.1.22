...
public abstract class OpenSslSessionContext implements SSLSessionContext {
    ...
    /**
     * Enable or disable caching of SSL sessions.启用或禁用SSL会话的缓存。
     */
    public abstract void setSessionCacheEnabled(boolean enabled);

    /**
     * Return {@code true} if caching of SSL sessions is enabled, {@code false} otherwise.如果启用SSL会话的缓存，返回true，否则返回false。
     */
