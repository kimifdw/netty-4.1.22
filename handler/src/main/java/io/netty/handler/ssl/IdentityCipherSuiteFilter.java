...
/**
 * This class will not do any filtering of ciphers suites.这个类不会过滤任何密码套件。
 */
public final class IdentityCipherSuiteFilter implements CipherSuiteFilter {

    /**
     * Defaults to default ciphers when provided ciphers are null 当提供密码为空时，默认为默认密码。
     */
    public static final IdentityCipherSuiteFilter INSTANCE = new IdentityCipherSuiteFilter(true);

    /**
     * Defaults to supported ciphers when provided ciphers are null 当提供的密码为空时，默认为支持的密码
     */
