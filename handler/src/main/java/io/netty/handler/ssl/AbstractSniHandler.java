...
public abstract class AbstractSniHandler<T> extends ByteToMessageDecoder implements ChannelOutboundHandler {
     ...
     * notify the {@link #onLookupComplete(ChannelHandlerContext, String, Future)} on completion.开始查找指定的SNI值，然后返回一个Future，该Future将在完成时通知onLookupComplete(ChannelHandlerContext, String, Future)。
     *
    ...
    /**
     * Called upon completion of the {@link #lookup(ChannelHandlerContext, String)} {@link Future}.在查找(ChannelHandlerContext，字符串)完成时调用。
     *
