 ...
 * }
 * </pre>
 * 根据SslHandler的应用程序级别协议协商结果配置通道管道。例如，您可以根据ALPN的结果配置您的HTTP管道:
 */
public abstract class ApplicationProtocolNegotiationHandler extends ChannelInboundHandlerAdapter {
     ...
     * for the negotiated application-level protocol.在成功的初始SSL/TLS握手时调用。实现此方法以配置已协商的应用程序级协议的管道。
     *
    ...
    /**
     * Invoked on failed initial SSL/TLS handshake.初始SSL/TLS握手失败时调用。
     */
