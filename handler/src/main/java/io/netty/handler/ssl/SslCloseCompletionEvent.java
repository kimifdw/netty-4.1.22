 ...
 * 在接收close_notify之后触发的事件，或者在接收失败之前发生的事件。
 */
//饿汉式单例模式
public final class SslCloseCompletionEvent extends SslCompletionEvent {
    ...
    /**
     * Creates a new event that indicates a successful receiving of close_notify.创建一个新的事件，该事件指示成功接收close_notify。
     */
     ...
     * 创建一个新的事件，该事件指示由于先前的错误而没有收到close_notify。使用成功来表示成功。
     */
