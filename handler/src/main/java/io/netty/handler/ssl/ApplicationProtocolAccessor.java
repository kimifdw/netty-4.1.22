...
/**
 * Provides a way to get the application-level protocol name from ALPN or NPN.提供了从ALPN或NPN获得应用程序级协议名称的方法。
 */
interface ApplicationProtocolAccessor {
    /**
     * Returns the name of the negotiated application-level protocol.返回协商的应用程序级协议的名称。
     *
