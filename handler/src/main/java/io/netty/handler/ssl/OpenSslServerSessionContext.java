...
/**
 * {@link OpenSslSessionContext} implementation which offers extra methods which are only useful for the server-side.OpenSslSessionContext实现，它提供了仅对服务器端有用的额外方法。
 */
public final class OpenSslServerSessionContext extends OpenSslSessionContext {
     ...
     * 设置会话被重用的上下文(仅在服务器端)，参见man SSL_CTX_set_session_id_context
     */
