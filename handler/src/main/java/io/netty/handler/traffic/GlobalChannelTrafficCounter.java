 ...
 * GlobalChannelTrafficShapingHandler版本。这个流量计数器是全局的，它的特殊属性是直接处理其他频道的流量计数器。特别是，这些通道的流量计数器没有调度器，因为它是由该通道管理的。
 */
public class GlobalChannelTrafficCounter extends TrafficCounter {
     ...
     * This version is Mixed in the way it mixes Global and Channel counters.类以在固定延迟时实现监视。这个版本混合了全局计数器和通道计数器。
     */
