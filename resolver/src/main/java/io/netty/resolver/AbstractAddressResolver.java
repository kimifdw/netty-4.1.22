...
public abstract class AbstractAddressResolver<T extends SocketAddress> implements AddressResolver<T> {
     ...
     * by {@link #resolve(SocketAddress)}.返回EventExecutor，用于通知侦听器解析返回的未来(SocketAddress)。
     */
     ...
     * already.isresolve (SocketAddress)调用来检查指定的地址是否已经解析。
     */
     ...
     * resolution.由resolve(SocketAddress)调用来执行实际的名称解析。
     */
