...
/**
 * Expose helper methods which create different {@link RejectedExecutionHandler}s.公开创建不同rejectedexecutionhandler的助手方法。
 */
public final class RejectedExecutionHandlers {
    ...
    /**
     * Returns a {@link RejectedExecutionHandler} that will always just throw a {@link RejectedExecutionException}.返回一个RejectedExecutionHandler，它会抛出一个RejectedExecutionException异常。
     */
