...
/**
 * Abstract base class for {@link EventExecutor}s that want to support scheduling.要支持调度的事件执行器的抽象基类。
 */
...
//        如果任务超时就删除
     ...
     * 当下一个计划任务准备好运行时，返回纳秒;如果没有计划任务，则返回-1。
     */
    ...
    /**
     * Returns {@code true} if a scheduled task is ready for processing.如果计划的任务已准备好进行处理，则返回true。
     */
