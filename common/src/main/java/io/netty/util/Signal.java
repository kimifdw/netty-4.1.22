 ...
 * {@link Signal} has an empty stack trace and has no cause to save the instantiation overhead.一种特殊的错误，用来通过抛出某个状态或请求来发出信号。Signal有一个空堆栈跟踪，没有理由保存实例化开销。
 */
public final class Signal extends Error implements Constant<Signal> {
     ...
     * be thrown.检查给定的信号是否与此实例相同。如果没有，将抛出非法州异常。
     */
