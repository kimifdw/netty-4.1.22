...
/**
 * A simple list which is recyclable. This implementation does not allow {@code null} elements to be added.一个可回收的简单清单。此实现不允许添加空元素。
 */
public final class RecyclableArrayList extends ArrayList<Object> {
    ...
    /**
     * Create a new empty {@link RecyclableArrayList} instance with the given capacity.使用给定的容量创建一个新的空的可回收列表实例。
     */
