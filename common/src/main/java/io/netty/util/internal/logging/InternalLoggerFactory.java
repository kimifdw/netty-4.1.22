...
public abstract class InternalLoggerFactory {
     ...
     * {@link JdkLoggerFactory}.返回默认的工厂。初始的默认工厂是JdkLoggerFactory。
     */
    ...
    /**
     * Creates a new logger instance with the name of the specified class.使用指定类的名称创建一个新的日志记录器实例。
     */
    ...
    /**
     * Creates a new logger instance with the specified name.创建具有指定名称的新日志记录器实例。
     */
