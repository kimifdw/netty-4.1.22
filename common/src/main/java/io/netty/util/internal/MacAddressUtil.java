...
public final class MacAddressUtil {
     ...
     * networks is better than a local network interface.获得在本地网络接口上找到的最佳MAC地址。一般来说，在公共网络上使用的主动网络接口优于本地网络接口。
     *
     ...
     * address.如果非null，返回bestAvailableMac()的结果，否则返回随机的EUI-64 MAC地址。
     */
    ...
    /**
     * Parse a EUI-48, MAC-48, or EUI-64 MAC address from a {@link String} and return it as a {@code byte[]}.从字符串中解析EUI-48、MAC-48或EUI-64 MAC地址，并将其作为字节返回[]。
