...
/**
 * The {@link PlatformDependent} operations which requires access to {@code sun.misc.*}.需要访问sun.misc.*的平台相关操作。
 */
final class PlatformDependent0 {
     ...
     * during a large copy.限制每个不安全的副本的字节数。copyMemory(长、长、长)允许在大型副本期间进行safepoint轮询。
     */
