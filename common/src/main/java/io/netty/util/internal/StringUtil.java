...
public final class StringUtil {
    ...
    /**
     * Checks if two strings have the same suffix of specified length 检查两个字符串是否具有指定长度的相同后缀
     *
     * @param s   string
     * @param p   string
    ...
    /**
     * Helper to decode half of a hexadecimal number from a string.从字符串解码十六进制数的一半的助手。
