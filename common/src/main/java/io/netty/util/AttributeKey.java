 ...
 *           可用于从AttributeMap中访问属性的键。注意，不可能有多个键具有相同的名称。
 */
...
public final class AttributeKey<T> extends AbstractConstant<AttributeKey<T>> {
    ...
    /**
     * Returns {@code true} if a {@link AttributeKey} exists for the given {@code name}.如果给定名称存在AttributeKey，则返回true。
     */
     ...
     * {@link IllegalArgumentException} if a {@link AttributeKey} for the given {@code name} exists.为给定的名称创建一个新的AttributeKey，如果给定名称的AttributeKey存在，则使用IllegalArgumentException失败。
     */
    @SuppressWarnings("unchecked")
