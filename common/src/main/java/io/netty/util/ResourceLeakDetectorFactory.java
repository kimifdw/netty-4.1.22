...
//    饿汉式单例模式
    ...
    /**
     * Get the singleton instance of this factory class.获取这个工厂类的单例实例。
     *
...
//
     ...
     * Netty Bootstrap.设置工厂的单例实例。在此工厂的所有调用者调用ResourceLeakDetector的静态初始化程序之前，必须先调用它。也就是说，在初始化Netty引导程序之前。
     *
    ...
    /**
     * Returns a new instance of a {@link ResourceLeakDetector} with the given resource class.返回带有给定资源类的resourakdetector的新实例。
     *
...
//
    ...
    /**
     * @deprecated Use {@link #newResourceLeakDetector(Class, int)} instead.返回带有给定资源类的resourakdetector的新实例。
     * <p>
...
//
    ...
    /**
     * Default implementation that loads custom leak detector via system property 通过系统属性加载自定义泄漏检测器的默认实现
     */
