...
/**
 * Default implementation of a {@link ByteBufHolder} that holds it's data in a {@link ByteBuf}.ByteBufHolder的默认实现，它将数据保存在ByteBuf中。
 *
 */
public class DefaultByteBufHolder implements ByteBufHolder {
     ...
     * {@link #retainedDuplicate()} invokes this method to create a copy.重写此方法以返回该对象的新实例，该实例的内容被设置为指定的内容。copy()、duplicate()和retainedDuplicate()的默认实现调用此方法创建副本。
     */
    @Override
     ...
     * {@link #toString()}.返回ByteBuf.toString()，而不首先检查引用计数。这对于实现toString()非常有用。
     */
