 ...
 * 将数据写入ByteBuf的输出流。
针对该流的写操作将在其底层缓冲区的writerIndex发生，在写操作期间，writerIndex将增加。
为了方便您，这个流实现了数据输出。流的机缘性并不总是很大，而是取决于底层缓冲区的机缘性。
 */
public class ByteBufOutputStream extends OutputStream implements DataOutput {
    ...
    /**
     * Creates a new stream which writes data to the specified {@code buffer}.创建一个新的流，该流将数据写入指定的缓冲区。
     */
