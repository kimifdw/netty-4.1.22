 ...
 * 基于NIO ByteBuffer的缓冲区。建议使用unpoledbytebufallocator。directBuffer(int, int)， Unpooled.directBuffer(int)和Unpooled.wrappedBuffer(ByteBuffer)，而不是显式地调用构造函数。
 */
public class UnpooledDirectByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    /**
     * Creates a new direct buffer by wrapping the specified initial buffer.通过包装指定的初始缓冲区创建一个新的直接缓冲区。
     *
     * @param maxCapacity the maximum capacity of the underlying direct buffer
     */
