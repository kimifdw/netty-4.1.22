...
/**
 * Simplistic {@link ByteBufAllocator} implementation that does not pool anything.简单的ByteBufAllocator实现，不存储任何东西。
 */
public final class UnpooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    /**
     * Default instance which uses leak-detection for direct buffers.用于直接缓冲区的泄漏检测的默认实例。
     */
    public static final UnpooledByteBufAllocator DEFAULT =
            new UnpooledByteBufAllocator(PlatformDependent.directBufferPreferred());

    /**
     * Create a new instance which uses leak-detection for direct buffers.创建一个新的实例，该实例对直接缓冲区使用泄漏检测。
     *
