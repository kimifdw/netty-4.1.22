...
/**
 * A skeletal implementation of a buffer.一个缓冲区的骨架实现。
 */
...
//       确保之前缓冲区被释放
    ...
    /**
     * Creates a new {@link SwappedByteBuf} for this {@link ByteBuf} instance.为这个ByteBuf实例创建一个新的SwappedByteBuf。
     */
     ...
     * than the specified value.如果该缓冲区的当前可读字节小于指定值，则抛出IndexOutOfBoundsException。
     */
     ...
     * if the buffer was released before.应该由每个试图访问缓冲区内容的方法调用，以检查缓冲区以前是否被释放。
     */
