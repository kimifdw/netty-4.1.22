...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    /**
     * Default number of heap arenas - System Property: io.netty.allocator.numHeapArenas - default 2 * cores 系统属性:io.netty.allocator.numHeapArenas -默认2 *核
     */
    ...
    /**
     * Default number of direct arenas - System Property: io.netty.allocator.numDirectArenas - default 2 * cores 系统属性:io.netty.allocator.numDirectArenas -默认2 *核
     */
    ...
    /**
     * Default buffer page size - System Property: io.netty.allocator.pageSize - default 8192 默认的缓冲页大小-系统属性:io.netty.allocator.pageSize -默认的8192
     */
     ...
     * 默认的最大订单-系统属性:io.netty.allocator.maxOrder -默认的11
     */
    ...
    /**
     * Return {@code true} if direct memory cache alignment is supported, {@code false} otherwise.如果支持直接内存缓存对齐，则返回true，否则返回false。
     */
     ...
     * buffers.如果调用线程有分配缓冲区的ThreadLocal缓存，则返回true。
     */
    @Deprecated
    ...
    /**
     * Free all cached buffers for the calling {@link Thread}.为调用线程释放所有缓存的缓冲区。
     */
    @Deprecated
    ...
    /**
     * Return a {@link List} of all heap {@link PoolArenaMetric}s that are provided by this pool.返回这个池提供的所有堆池竞技场的列表。
     *
    ...
    /**
     * Return a {@link List} of all direct {@link PoolArenaMetric}s that are provided by this pool.返回该池提供的所有直接池配置表。
     *
    ...
    /**
     * Return the number of thread local caches used by this {@link PooledByteBufAllocator}.返回这个PooledByteBufAllocator使用的线程本地缓存的数量。
     *
    ...
    /**
     * Return the size of the tiny cache.返回小缓存的大小。
     *
     ...
     * and so should not called too frequently.返回分配器的状态(它包含所有指标)作为字符串。要知道这可能是昂贵的，所以不应该经常打电话。
     */
