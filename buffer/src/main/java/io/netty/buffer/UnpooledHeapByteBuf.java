 ...
 * 大端Java堆缓冲实现。建议使用unpoledbytebufallocator。heapBuffer(int, int)、Unpooled.buffer(int)和Unpooled.wrappedBuffer(byte[])，而不是显式调用构造函数。
 */
public class UnpooledHeapByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    /**
     * Creates a new heap buffer with a newly allocated byte array.使用新分配的字节数组创建一个新的堆缓冲区。
     *
...
//        设置buffer的读下标和写下标
    ...
    /**
     * Creates a new heap buffer with an existing byte array.使用现有字节数组创建新的堆缓冲区。
     *
