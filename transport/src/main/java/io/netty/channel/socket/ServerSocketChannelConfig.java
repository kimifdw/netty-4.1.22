 ...
 * </tr>
 * </table>
 * 除了ChannelConfig提供的选项之外，ServerSocketChannelConfig允许选项映射中的以下选项:
 */
public interface ServerSocketChannelConfig extends ChannelConfig {

    /**
     * Gets the backlog value to specify when the channel binds to a local
     * address.获取要指定通道何时绑定到本地地址的backlog值。
     */
    int getBacklog();
     ...
     * {@link ServerSocket#setPerformancePreferences(int, int, int)}.设置在ServerSocket中指定的性能首选项。setPerformancePreferences(int,int,int)。
     */
