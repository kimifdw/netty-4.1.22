 ...
 * {@code true}.
 * 将被触发并传递给ChannelInboundHandler的特殊事件。一旦一个SocketChannel的输入被关闭，并且SocketChannelConfig.isAllowHalfClosure()方法返回true，那么usereventtrigger (ChannelHandlerContext, Object)方法就会返回。
 */
//饿汉式单例模式
