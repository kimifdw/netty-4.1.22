 ...
 *  将ChannelInboundHandler和ChannelOutboundHandler合并到一个ChannelHandler中。
 */
public class CombinedChannelDuplexHandler<I extends ChannelInboundHandler, O extends ChannelOutboundHandler>
     ...
     * 创建一个新的未初始化的实例。扩展此处理程序的类在将该处理程序添加到channelboundhandler之前必须调用init(ChannelInboundHandler, ChannelOutboundHandler)。
     */
    ...
    /**
     * Creates a new instance that combines the specified two handlers into one.创建一个新实例，将指定的两个处理程序合并为一个。
     */
    ...
    /**
     * Initialized this handler with the specified handlers.使用指定的处理程序初始化此处理程序。
     *
     ...
     * 删除组合ChannelInboundHandler中合并的channelduplexhandler。
     */
     ...
     * 删除在这个组合channelduplexhandler中组合的ChannelOutboundHandler。
     */
