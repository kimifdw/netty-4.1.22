...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
     ...
     * {@link ChannelGroupFuture}s.使用生成的名称和提供的EventExecutor创建一个新组，通知ChannelGroupFutures。
     */
     ...
     * duplicate check is done against group names.创建一个具有指定名称和EventExecutor的新组，以通知ChannelGroupFutures。请注意，不同的组可以有相同的名称，这意味着不对组名称进行重复检查。
     */
     ...
     * easy, to shutdown server and child channels at once.使用生成的名称和提供的EventExecutor创建一个新组，通知ChannelGroupFutures。stayClosed定义这个组是否可以被关闭多次。向封闭组添加通道也会立即关闭它们。这使得立即关闭服务器和子通道变得很容易。
     */
     ...
     * 创建一个具有指定名称和EventExecutor的新组，以通知ChannelGroupFutures。stayClosed定义这个组是否可以被关闭多次。向封闭组添加通道也会立即关闭它们。这使得立即关闭服务器和子通道变得很容易。请注意，不同的组可以有相同的名称，这意味着不对组名称进行重复检查。
     */
