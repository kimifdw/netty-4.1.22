...
/**
 * Represents the properties of a {@link Channel} implementation.表示通道实现的属性。
 */
public final class ChannelMetadata {
     ...
     * such as UDP/IP.如果且仅当通道具有允许用户断开连接，然后再次调用channel .connect(SocketAddress)(比如UDP/IP)的disconnect()操作时返回true。
     */
     ...
     * {@link MaxMessagesRecvByteBufAllocator#maxMessagesPerRead()}.如果正在使用MaxMessagesRecvByteBufAllocator，那么这是maxmessagesrecvbytebufalator . maxmessagesperread()的默认值。
     */
