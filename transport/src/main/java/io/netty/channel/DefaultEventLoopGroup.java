...
/**
 * {@link MultithreadEventLoopGroup} which must be used for the local transport.必须用于本地传输的MultithreadEventLoopGroup。
 */
public class DefaultEventLoopGroup extends MultithreadEventLoopGroup {

    /**
     * Create a new instance with the default number of threads.使用默认的线程数创建一个新实例。
     */
