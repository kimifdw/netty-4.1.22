 ...
 * {@code 0}.默认的FileRegion实现，它从文件通道或文件传输数据。注意，一旦refCnt()返回0，文件通道将自动关闭。
 */
public class DefaultFileRegion extends AbstractReferenceCounted implements FileRegion {
     ...
     * explicitly via {@link #open()}.使用给定的文件创建一个新实例。文件将通过open()缓慢地或显式地打开。
     *
    ...
    /**
     * Returns {@code true} if the {@link FileRegion} has a open file-descriptor 如果FileRegion具有打开的文件描述符，则返回true
     */
    ...
    /**
     * Explicitly open the underlying file-descriptor if not done yet.如果还没有打开底层文件描述符，则显式地打开它。
     */
