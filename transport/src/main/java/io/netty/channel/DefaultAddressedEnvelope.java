...
/**
 * The default {@link AddressedEnvelope} implementation.默认AddressedEnvelope实现。
 *
...
public class DefaultAddressedEnvelope<M, A extends SocketAddress> implements AddressedEnvelope<M, A> {
     ...
     * {@code sender} address.使用指定的消息、收件人地址和发件人地址创建一个新实例。
     */
     ...
     * The sender address becomes {@code null}.使用指定的消息和收件人地址创建一个新实例。发送方地址变为空。
     */
