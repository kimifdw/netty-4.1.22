...
/**
 * A {@link ServerChannel} for the local transport which allows in VM communication.支持VM通信的本地传输的一个服务器通道。
 */
public class LocalServerChannel extends AbstractServerChannel {
     ...
     * to create custom instances of {@link LocalChannel}s.本地通道的工厂方法。用户可以重写它来创建LocalChannels的自定义实例。
     */
