 ...
 * {@link ByteBuf}, {@link ByteBufHolder} and {@link FileRegion}.默认的MessageSizeEstimator实现，支持对ByteBuf、ByteBufHolder和FileRegion大小的估计。
 */
public final class DefaultMessageSizeEstimator implements MessageSizeEstimator {
    ...
    /**
     * Return the default implementation which returns {@code 8} for unknown messages.返回默认实现，对于未知消息返回8。
     */
