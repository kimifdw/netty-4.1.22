 ...
 *           ChannelOption允许以类型安全的方式配置ChannelConfig。支持哪个ChannelOption取决于ChannelConfig的实际实现，可能取决于它所属的传输的性质。
 */
public class ChannelOption<T> extends AbstractConstant<ChannelOption<T>> {
     ...
     * may override this for special checks.验证为ChannelOption设置的值。子类可能会覆盖这个以进行特殊检查。
     */
