...
/**
 * Exposes the configuration of a {@link ServerBootstrapConfig}.公开ServerBootstrapConfig的配置。
 */
public final class ServerBootstrapConfig extends AbstractBootstrapConfig<ServerBootstrap, ServerChannel> {
     ...
     * if non is configured yet.返回已配置的ChannelHandler用于子通道，如果尚未配置non，则返回null。
     */
    ...
    /**
     * Returns a copy of the configured options which will be used for the child channels.返回配置选项的副本，该副本将用于子通道。
     */
    ...
    /**
     * Returns a copy of the configured attributes which will be used for the child channels.返回将用于子通道的配置属性的副本。
     */
