 ...
 * which enables easier server side HTTP implementation.HttpRequestDecoder和HttpResponseEncoder的组合，使服务器端HTTP实现更容易。
 *
 * @see HttpClientCodec
 */
public final class HttpServerCodec extends CombinedChannelDuplexHandler<HttpRequestDecoder, HttpResponseEncoder>
     ...
     * {@code maxChunkSize (8192)}).使用默认解码器选项(maxInitialLineLength(4096}、maxHeaderSize(8192)和maxChunkSize(8192))创建一个新实例。
     */
     ...
     * {@link HttpResponseEncoder} from the pipeline.从HTTP升级到另一个协议。从管道中删除HttpRequestDecoder和HttpResponseEncoder。
     */
    @Override
