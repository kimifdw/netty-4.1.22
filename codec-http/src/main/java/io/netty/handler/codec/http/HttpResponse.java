 ...
 * 一个HTTP响应。
访问饼干
与Servlet API不同，io.netty.handler.c .cookie. cookie支持是通过io.netty.handler.c .cookie。cooke . servercookiedecoder, io.c。
 */
public interface HttpResponse extends HttpMessage {
    ...
    /**
     * Returns the status of this {@link HttpResponse}.返回HttpResponse的状态。
     *
