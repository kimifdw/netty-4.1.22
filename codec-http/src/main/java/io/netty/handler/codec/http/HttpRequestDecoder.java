 ...
 * </tr>
 * </table>
 * 将ByteBufs解码为httprequest和HttpContents。
 防止过度内存消耗的参数
 的名字
 意义
 ...
 maxChunkSize
 内容或每个块的最大长度。如果内容长度超过此值，解码请求的传输编码将被转换为“分块”，内容将被分割为多个HttpContents。如果HTTP请求的传输编码已经“分块”，那么如果块的长度超过这个值，每个块将被分割成更小的块。如果您不想在处理程序中处理HttpContents，请在ChannelPipeline中在这个解码器之后插入HttpObjectAggregator。
 */
