 ...
 * 一个HTTP请求。
访问查询参数和Cookie
与Servlet API不同，查询字符串由QueryStringEncoder和QueryStringDecoder构造和分解。cookie. cookie. cookie. cookie. cookie. cookie. cookie. cookie. cookie. cookie。cookie的支持也分别通过io.net .handler. servercookiedecoder和io.net .handler. clientcookiedecoder提供。
 */
