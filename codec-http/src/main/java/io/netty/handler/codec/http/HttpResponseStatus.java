 ...
 * 响应代码及其对HTTP或其派生协议的描述，如RTSP和ICAP。
 */
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
     ...
     * 返回由指定代码表示的HttpResponseStatus。如果指定的代码是标准的HTTP状态代码，则会返回一个缓存的实例。否则，将返回一个新实例。
     */
     ...
     * 返回由指定代码和推理短语表示的HttpResponseStatus。如果指定的代码是标准的HTTP状态代码和推理短语，则会返回一个缓存的实例。否则，将返回一个新实例。
     */
    ...
    /**
     * Creates a new instance with the specified {@code code} and the auto-generated default reason phrase.使用指定的代码和自动生成的默认原因短语创建一个新实例。
     */
    ...
    /**
     * Creates a new instance with the specified {@code code} and its {@code reasonPhrase}.使用指定的代码及其推理短语创建新实例。
     */
    ...
    /**
     * Returns the reason phrase of this {@link HttpResponseStatus}.返回HttpResponseStatus的原因短语。
     */
