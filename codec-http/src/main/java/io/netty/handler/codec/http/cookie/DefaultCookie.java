...
public class DefaultCookie implements Cookie {
    ...
    /**
     * Creates a new cookie with the specified name and value.创建具有指定名称和值的新cookie。
     */
     ...
     * 验证cookie属性值，否则抛出IllegalArgumentException。仅供io.net .handler.codec.http. defaultcookie使用。
     */
    @Deprecated
