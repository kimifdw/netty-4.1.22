 ...
 * of the {@link ByteBuf}.
 * 必须与MarshallingEncoder一起使用的译码器。使用Unmarshaller从ByteBuf中读取对象的LengthFieldBasedFrameDecoder。
 *
 */
public class MarshallingDecoder extends LengthFieldBasedFrameDecoder {
     ...
     * raised.创建一个新的解码器，其最大对象大小为1048576字节。如果接收到的对象的大小大于1048576字节，则会引发stream行文格式的dexception。
     *
     */
