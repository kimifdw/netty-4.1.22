 ...
 * }
 * </pre>
 * 将接收到的ByteBuf解码为谷歌协议缓冲消息和MessageLite。请注意，如果您正在使用基于流的传输(如TCP/IP)，那么这个解码器必须与合适的ByteToMessageDecoder(如ProtobufVarint32FrameDecoder)或LengthFieldBasedFrameDecoder)一起使用。TCP/IP的典型设置是:
