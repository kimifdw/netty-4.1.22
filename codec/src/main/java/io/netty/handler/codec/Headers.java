 ...
 * Duplicate keys may be allowed by implementations.头的通用接口，表示键到值的映射。实现可能允许重复键。
 *
...
public interface Headers<K, V, T extends Headers<K, V, T>> extends Iterable<Entry<K, V>> {
     ...
     * the first value in insertion order is returned.返回具有指定名称的标头的值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     ...
     * one value for the specified name, the first value in insertion order is returned.返回具有指定名称的标头的值，并将其从该对象中删除。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
    ...
    /**
     * Returns all values for the header with the specified name. The returned {@link List} can't be modified.返回具有指定名称的头的所有值。无法修改返回的列表。
     *
     * @param name the name of the header to retrieve
     ...
     * The returned {@link List} can't be modified.返回具有指定名称的头的所有值，并从该对象中删除它们。无法修改返回的列表。
     *
     * @param name the name of the header to retrieve
     * @return a {@link List} of header values or an empty {@link List} if no values are found.
     */
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的标题的布尔值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的头的字节值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的标题的char值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的标头的短值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的标头的int值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.返回具有指定名称的标头的长值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     * specified name, the first value in insertion order is returned.以毫秒为单位返回具有指定名称的标头的值。如果指定的名称有多个值，则返回插入顺序中的第一个值。
     *
     * @param name the name of the header to retrieve
     ...
     *         such value or it can't be converted to {@code boolean}.
     *         返回一个头的布尔值与指定的名称和删除这个对象的头。如果有一个以上的值指定的名字,第一个返回值插入顺序。在任何情况下所有的值的名字都被删除了。
    如果一个例外发生在类型T所有条目名称的翻译仍可能被删除。
     */
    ...
    /**
     * Returns {@code true} if a header with the {@code name} exists, {@code false} otherwise.如果标题存在，则返回true，否则返回false。
     *
     ...
     *              如果有名称和值的标题存在，则返回true，否则为false。
    Object.equals(Object)方法用于测试值的相等性。
     */
    boolean contains(K name, V value);

    /**
     * Returns {@code true} if a header with the name and value exists.如果存在带有名称和值的头，则返回true。
     *
     * @param name the header name
    ...
    /**
     * Returns a {@link Set} of all header names in this object. The returned {@link Set} cannot be modified.返回该对象中所有头名的集合。不能修改返回的集合。
     */
    Set<K> names();
     ...
     * @param values the value of the header
     * @return {@code this}
     * 使用指定的名称和值设置标题。删除此名称的任何现有标题。该方法等价于:
     */
