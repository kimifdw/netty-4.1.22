...
/**
 * Compresses a {@link ByteBuf} using the deflate algorithm.使用紧缩算法压缩ByteBuf。
 */
public class JZlibEncoder extends ZlibEncoder {
     ...
     * 使用默认压缩级别(6)、默认窗口位(15)、默认内存级别(8)和默认包装器(zlibwrap . zlib)创建一个新的zlib编码器。
     */
    public JZlibEncoder() {
        this(6);
    }
     ...
     *
     * @throws CompressionException if failed to initialize zlib
     * 使用指定的压缩级别、默认窗口位(15)、默认内存级别(8)和默认包装器(zlibwrap . zlib)创建一个新的zlib编码器。
     */
     ...
     *
     * @throws CompressionException if failed to initialize zlib
     * 使用默认的压缩级别(6)、默认的窗口位(15)、默认的内存级别(8)和指定的包装器创建一个新的zlib编码器。
     */
     ...
     * Creates a new zlib encoder with the specified {@code compressionLevel},
     * default window bits ({@code 15}), default memory level ({@code 8}),
     * and the specified wrapper.使用指定的压缩级别、默认窗口位(15)、默认内存级别(8)和指定的包装器创建一个新的zlib编码器。
     *
     * @param compressionLevel
     *        {@code 1} yields the fastest compression and {@code 9} yields the
     *        best compression.  {@code 0} means no compression.  The default
     ...
     * the preset dictionary.使用默认的压缩级别(6)、默认窗口位(15)、默认内存级别(8)和指定的预置字典创建一个新的zlib编码器。包装器总是ZlibWrapper。ZLIB是因为它是唯一支持预设字典的格式。
     *
     ...
     *
     * @throws CompressionException if failed to initialize zlib
     * 使用指定的压缩级别、默认窗口位(15)、默认内存级别(8)和指定的预定义字典创建一个新的zlib编码器。包装器总是ZlibWrapper。ZLIB是因为它是唯一支持预设字典的格式。
     */
