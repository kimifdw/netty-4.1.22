 ...
 * 一种实时编码/解码字节到消息的编码，反之亦然。这可以看作是ByteToMessageDecoder和MessageToByteEncoder的组合。注意ByteToMessageCodec的子类不能用@Sharable注释。
 */
public abstract class ByteToMessageCodec<I> extends ChannelDuplexHandler {
    ...
    /**
     * see {@link #ByteToMessageCodec(boolean)} with {@code true} as boolean parameter.见ByteToMessageCodec(boolean)，为true作为布尔参数。
     */
    ...
    /**
     * see {@link #ByteToMessageCodec(Class, boolean)} with {@code true} as boolean value.见ByteToMessageCodec(类，布尔)，其值为true。
     */
