...
/**
 * Decompress a {@link ByteBuf} using the inflate algorithm.使用膨胀算法解压缩ByteBuf。
 */
public class JdkZlibDecoder extends ZlibDecoder {
    ...
    /**
     * Creates a new instance with the default wrapper ({@link ZlibWrapper#ZLIB}).使用默认的包装器(zlibwrap . zlib)创建一个新实例。
     */
     ...
     * supported atm.使用指定的包装器创建一个新实例。注意，只有ZlibWrapper。GZIP,ZlibWrapper。ZLIB ZlibWrapper。没有一个支持atm。
     */
