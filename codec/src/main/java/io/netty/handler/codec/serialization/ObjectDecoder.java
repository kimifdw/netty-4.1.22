 ...
 * 将接收到的ByteBufs反序列化为Java对象的解码器。
 请注意，此解码器期望的序列化格式与标准ObjectOutputStream不兼容。请使用ObjectEncoder或ObjectEncoderOutputStream来确保与此解码器的互操作性。
 */
public class ObjectDecoder extends LengthFieldBasedFrameDecoder {
     ...
     *                       创建一个新的解码器，其最大对象大小为1048576字节。如果接收到的对象的大小大于1048576字节，则会引发stream行文格式的dexception。
     */
    ...
    /**
     * Creates a new decoder with the specified maximum object size.使用指定的最大对象大小创建一个新的解码器。
     *
